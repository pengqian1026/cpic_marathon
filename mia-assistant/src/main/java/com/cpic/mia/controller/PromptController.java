...
public class PromptController {
    ...
    public CommonResult pormpt(@RequestBody MiaPromptRequest request) throws Exception {
        ...
        if(userCheckFlag.equals("0")){
            ...
            AnalysisDataVO analysisDataVO = this.directReply(request, result);
    ...
    //非json数据返回
    private AnalysisDataVO directReply(MiaPromptRequest request,ChatOutRequst result) throws Exception {
        ...
        analysisDataVO.setSuggestList(suggestList);
